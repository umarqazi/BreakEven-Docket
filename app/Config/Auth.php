...
class Auth extends \Myth\Auth\Config\Auth
{
	 ...
	 * @var string[]
	 */
	public $personalFields = ['first_name','last_name','phone','mobile','address','address1','zip','city','notes','user_type','profile_pic','invoice_signature','state','company_id','company_name','activation_code','token','display_name','is_verified','password_hash', 'reset_hash', 'reset_at', 'reset_expires', 'activate_hash', 'status', 'status_message', 'active', 'force_pass_reset', 'permissions', 'deleted_at','is_super_admin'];
