...
class AuthController extends Controller
{
	...
	public function attemptLogin()
	{
		...
		if($this->request->getPost('is_admin')){
			if($this->auth->user()->is_super_admin == 1) {
				$redirectURL = site_url('admin/index');
			} else {
	...
	public function userLogout()
	{
		...
		return redirect()->to(site_url('login'))->with('error', lang('Wrong Credientials!'));
	}
