                    ...
                    <div class="jop_wrapper">
                        ...
                        <form id="store_assign_form" method="post" action="<?= route_to('assign_docket') ?>">
                            ...
                            if (!empty($employees)) { ?>
                                ...
                                <button type="button" onclick="checkDocektNo()" class="btn btn-info job_btn btn_docket_no">Assign</button>
                            <?php } else { ?>
                                <div style="color: white!important; font-family:'Times New Roman'; font-size: 15px;">
                                    No Employee Found, Please Add Employees First!
                                </div>
                            <?php } ?>
                        </form>
                    </div>
