                ...
                <table cellpadding="0" cellspacing="0" class="force-full-width">
                  <tr>
                   <td height="60" valign="top" class="header-cell">
                      <!-- <img style="margin-top: 10px;" width="70" height="70" src="'.$company_folder['logo_web_path'].$company['company_logo'].'" alt="logo"> -->
                      here comes the company image
                    </td>
                  </tr>
                  <tr>
                      ...
                      <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                        <tr>
                          <td valign="top" style="padding-bottom:15px; background-color:#ffffff;">
                            <h1>Welcome to BreakEven DOCKET<sup>®</sup></h1>
                          </td>
                        </tr>
                        <tr>
                          <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                            <b>Hi <?= $userdata['first_name'].' '.$userdata['last_name'] ?>, your account has been created!</b><br>
                        ...
                        <tr>
                          <td>
                            <table cellspacing="0" cellpadding="0" width="100%" bgcolor="#ffffff">
                              <tr>
                                <td style="width:175px;background:rgb(1, 92, 130);">
                                  <div>
                                  	<a href="<?= base_url().'/employee-verify/'.$userdata['user_id'].'/'.$userdata['activation_code'] ?>" style="background-color:rgb(1, 92, 130);color:#ffffff;display:inline-block;font-family:sans-serif;font-size:16px;line-height:35px;text-align:center;text-decoration:none;width:175px;-webkit-text-size-adjust:none;">Activate Account</a>
                                  </div>
                                </td>
